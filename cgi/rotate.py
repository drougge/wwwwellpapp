...
<svg width="%(sw)d" height="%(sh)d" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
<image width="%(iw)d" height="%(ih)d" y="%(y)d" x="%(x)d" xlink:href="%(url)s" transform="rotate(%(rot)s)"/>
</svg>"""
